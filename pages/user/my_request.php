...
<body>
    <div class="d-flex flex-column flex-md-row">
        ...
        <div class="container mt-5" style="background-color: #f4faff; padding: 30px; border-radius: 20px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.15);">
            <h2 class="text-center mb-4" style="color: #1e3a8a; font-weight: bold; text-transform: uppercase;">My Requests</h2>
            <div class="table-responsive">
                <table class="table table-striped table-hover" style="border: 1px solid #1e3a8a; border-radius: 10px; overflow: hidden;">
                    <thead style="background-color: #1e3a8a; color: white;">
                        <tr>
                            <th style="background-color: #163a73; color: white;">ID</th>
                            <th style="background-color: #163a73; color: white;">Service Type</th>
                            <th style="background-color: #163a73; color: white;">Description</th>
                            <th style="background-color: #163a73; color: white;">Priority</th>
                            <th style="background-color: #163a73; color: white;">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        $sql = "SELECT id, service_type, description, priority, status FROM repair_requests WHERE user_id = $user_id ORDER BY created_at DESC";
